...
export default function App() {
  ...
  const EXTERNAL_LINK = "https://flexfitweb.vercel.app";
      ...
      <main className="pt-20">
        ...
        <section className="relative pt-24 pb-32 lg:pt-36 lg:pb-40 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto flex flex-col items-center text-center">
          ...
          >
            ...
            <p className="text-brand-volt font-medium text-sm md:text-base mt-2 bg-brand-volt/10 px-4 py-1.5 rounded-full border border-brand-volt/20">
              🎁 Get <span className="font-bold">₹100 Welcome Bonus</span> for the first 100 signups!
            </p>
          </motion.div>
            ...
            <div className="relative bg-brand-black rounded-[2.5rem] p-8 md:p-12 flex flex-col md:flex-row items-center justify-between gap-10 shadow-[0_0_50px_rgba(204,255,0,0.1)]">
              <div className="flex-1">
                ...
                <p className="text-lg text-slate-300 mb-6">
                  Sign up in the next <span className="text-white font-bold">14 Days</span> to get FREE 'Featured Gym' Status and a <span className="text-brand-volt font-bold">₹100 Welcome Bonus</span>.
                </p>
                <ul className="space-y-3">
                  {[
                    "₹100 Welcome Bonus (First 100 Signups)",
        ...
        <section id="waitlist-section" className="py-24 relative">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <motion.div 
              ...
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
              className="bg-white/[0.02] border border-white/10 rounded-[3rem] p-12 md:p-20 backdrop-blur-xl relative overflow-hidden"
            >
              <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full h-1 bg-gradient-to-r from-transparent via-brand-blue to-transparent"></div>
              
              <h2 className="text-4xl md:text-5xl font-display font-bold mb-6">Ready to Scale Your Gym?</h2>
              <p className="text-xl text-slate-400 mb-10 max-w-2xl mx-auto">
                Join the FlexFit network today and start filling your empty slots with high-intent fitness enthusiasts.
              </p>
              
              <button 
                onClick={handleCTAClick}
                className="bg-brand-blue hover:bg-blue-600 text-white px-12 py-5 rounded-full font-bold text-xl transition-all shadow-[0_0_40px_rgba(0,82,255,0.4)] hover:shadow-[0_0_60px_rgba(0,82,255,0.6)] flex items-center justify-center gap-3 mx-auto"
              >
                Get Started Now <ArrowRight size={24} />
              </button>
              
              <p className="mt-8 text-slate-500 text-sm">
                No setup fees. No long-term contracts. Just growth.
              </p>
            </motion.div>
          </div>
        </section>
